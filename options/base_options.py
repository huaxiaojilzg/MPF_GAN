...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # add model two dis
        parser.add_argument('--netD_w', type=str, default='pixel', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        ...
        ###############################################################
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size') #def 32 对比实验
        ###############################################################
